...
/* converts to decicelsius
 ...
 14	8750	750	14
 15	9375	375	*/
uint16_t DS18X20_temp_to_decicel(uint8_t res_meas[])

{
	uint16_t h;
	uint8_t i;
	uint8_t need_rounding[] = { 1, 3, 4, 6, 9, 11, 12, 14 };
	uint8_t subzero = res_meas[0];
	uint8_t cel = res_meas[1];
	uint8_t cel_frac_bits = res_meas[2];
...
uint8_t DS18X20_read_meas(uint8_t id[], uint8_t res_meas[])
...
/* 	#<{(| ES_SetTimerTask(START_MES, 5000); |)}># */
/* } */
/*  */
...
/* 	uint8_t sign; */
/* 	decicelsius = DS18X20_temp_to_decicel(resultMeasure); */
/* 	if (decicelsius == 0) */
/* 		sign = ' '; */
/* 	else */
/* 		sign = (resultMeasure[0]) ? '-' : '+'; */
/* 	if (decicelsius / 1000) { */
/* 		tempLcd[0] = sign; */
/* 		tempLcd[1] = (decicelsius / 1000) + '0'; */
/* 		tempLcd[2] = (decicelsius / 100) + '0'; */
/* 	} else if (decicelsius / 100) { */
/* 		tempLcd[0] = ' '; */
/* 		tempLcd[1] = sign; */
/* 		tempLcd[2] = (decicelsius / 100) + '0'; */
/* 	} else { */
...
/* 		tempLcd[2] = sign; */
/* 	} */
/* 	tempLcd[3] = (decicelsius / 10) % 10 + '0'; */
/* } */
/*  */
/* uint8_t search_sensors(void) { */
/* 	uint8_t i; */
/* 	uint8_t id[OW_ROMCODE_SIZE]; */
/* 	uint8_t diff, num_sen; */
/*  */
/* 	num_sen = 0; */
/*  */
/* 	for (diff = OW_SEARCH_FIRST; */
/* 			diff != OW_LAST_DEVICE && num_sen < MAXSENSORS;) { */
